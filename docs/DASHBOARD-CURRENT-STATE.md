...
**Stated directly in the codebase:** Finance today is mostly an AR subledger with a "Finance" label on it, plus a Gross Profit figure read straight off SAP's own per-invoice field (added 2026-07) — still never a true P&L/net-margin figure, because there's no GL/Chart-of-Accounts extraction from SAP.
