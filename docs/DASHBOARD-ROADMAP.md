...
**Execution plan (2026-07, phase numbering updated 2026-08):** the full phased build-out — Accounts Payable chain (**Phase 1, done 2026-07**), General Ledger (**Phase 2, done 2026-07**, plus the follow-up passes above), a Cash Flow Statement (**Phase 3, done 2026-08**, plus two rounds of live-tested follow-up fixes), per-warehouse inventory valuation (**Phase 4, renumbered from Phase 3 in 2026-08, not started**), a Balance Sheet (**Phase 5, done 2026-08**), and an Income Statement (**Phase 6, done 2026-08**, Statement of Changes in Equity confirmed feasible but not yet built) — plus an early DSO-formula reconciliation (**Phase 0, done 2026-07**) and new list pages for the new entities (**done alongside Phase 1, and again as a Phase 2 follow-up**) — is tracked in `hyrax-data-platform/docs/sap-data-architecture-plans/06-finance-expansion-execution-plan.md`. That doc owns the SAP table/column/schema decisions and phase sequencing per this repo's usual governance split; update its per-phase "Status" line as work lands. Phases 1-2's RPC and migrations are deployed; Phases 3/5/6's RPC and migrations are code-complete pending your Supabase Studio deploy step.
