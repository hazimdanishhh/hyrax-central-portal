...
| Sales Orders — All        | `/app/sales/orders/all`        | `sap_sales_orders_with_fulfillment` (native view over `sap_sales_orders (ORDR)`, `sap_sales_order_lines (RDR1)`, `sap_deliveries (ODLN)`/`sap_delivery_lines (DLN1)`, `sap_invoices_with_balance`, `sales_leads`), `sap_sales_orders (ORDR)` (pagination count + PO/customer lookups), `sap_invoice_lines (INV1)`, `sap_payments (ORCT)`/`sap_payment_applications (RCT2)` (sidebar), `employee_sales_rep_mapping` (native); RPC `get_fulfillment_overview` for the KPI cards. Traces each order through delivery, invoicing and payment — absorbed the short-lived standalone Fulfillment Tracker page (2026-09).                                                                                                                                                                                                                              |
...
| Page                                                                       | Route                                                                                                           | Tables / Source                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Invoices (tab of Invoices & A/R, merged 2026-09)                          | `/app/finance/invoices/list`                                                                                    | `sap_invoices (OINV)`, `sap_invoice_lines (INV1)`, `sap_delivery_lines`; RPC `get_invoices_overview` for the KPI cards (added a Total tile 2026-09 — count + gross amount across every currently-filtered invoice)                                                                                                                                                                                       |
| Payments (tab of Invoices & A/R, merged 2026-09)                          | `/app/finance/invoices/payments`                                                                                | `sap_payments (ORCT)`, `sap_payment_applications (RCT2)`, `sap_invoices`; RPC `get_payments_overview` for the KPI cards (Total tile added 2026-09)                                                                                                                                                                                                                                                        |
| Bills (AP) (tab of Bills & A/P, merged 2026-09)                           | `/app/finance/bills/list`                                                                                       | `sap_vendor_bills (OPCH)`, `sap_vendor_bill_lines (PCH1)`; RPC `get_bills_overview` for the KPI cards (Total tile added 2026-09)                                                                                                                                                                                                                                                                           |
| Vendor Payments (AP) (tab of Bills & A/P, merged 2026-09)                 | `/app/finance/bills/vendor-payments`                                                                             | `sap_vendor_payments (OVPM)`, `sap_vendor_payment_applications (VPM2)`, `sap_vendor_bills`; RPC `get_vendor_payments_overview` for the KPI cards (Total tile added 2026-09)                                                                                                                                                                                                                               |
| Journal Entries                                                            | `/app/finance/journal-entries`                                                                                  | `sap_gl_journal_entries (OJDT)`, `sap_gl_journal_lines (JDT1)`; list reads `sap_gl_journal_entries_with_flags` (view, added 2026-09) for `is_unbalanced`/`has_nonpostable_posting` row-flag columns — pagination `count` still runs against the raw table, not this view                                                                                                                                |
| Chart of Accounts                                                          | `/app/finance/chart-of-accounts`                                                                                | `sap_gl_accounts (OACT)` — default view is a `father_code`/`level` hierarchy tree (added 2026-09), falls back to a flat list on search/filter                                                                                                                                                                                                                                                            |
