...
| Page                                                                       | Route                                                                                                           | Tables / Source                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Invoices (tab of Invoices & A/R, merged 2026-09)                          | `/app/finance/invoices/list`                                                                                    | `sap_invoices (OINV)`, `sap_invoice_lines (INV1)`, `sap_delivery_lines`; RPC `get_invoices_overview` for the KPI cards                                                                                                                                                                                                                                                                                     |
| Payments (tab of Invoices & A/R, merged 2026-09)                          | `/app/finance/invoices/payments`                                                                                | `sap_payments (ORCT)`, `sap_payment_applications (RCT2)`, `sap_invoices`                                                                                                                                                                                                                                                                                                                                   |
| Bills (AP) (tab of Bills & A/P, merged 2026-09)                           | `/app/finance/bills/list`                                                                                       | `sap_vendor_bills (OPCH)`, `sap_vendor_bill_lines (PCH1)`; RPC `get_bills_overview` for the KPI cards                                                                                                                                                                                                                                                                                                      |
| Vendor Payments (AP) (tab of Bills & A/P, merged 2026-09)                 | `/app/finance/bills/vendor-payments`                                                                             | `sap_vendor_payments (OVPM)`, `sap_vendor_payment_applications (VPM2)`, `sap_vendor_bills`                                                                                                                                                                                                                                                                                                                 |
