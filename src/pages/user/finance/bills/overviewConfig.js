import { InvoiceIcon, ClockIcon, WarningCircleIcon } from "@phosphor-icons/react";
  ...
  return [
    {
      ...
      sublabel: "Unpaid Balance, Open Bills",
      value: compactCurrency(kpis.outstandingValue),
      variant: "blueCardFill",
      to: ".",
      filter: baseFilter,
      metrics: [
        { label: "Bills", value: kpis.outstandingCount, to: ".", filter: baseFilter },
      ],
    ...
    },
    {
      ...
      metrics: [
        { label: "Bills", value: kpis.dueSoonCount, to: ".", filter: dueSoonFilter },
      ],
    ...
    },
    {
      ...
      metrics: [
        { label: "Bills", value: kpis.overdueCount, to: ".", filter: overdueFilter },
      ],
