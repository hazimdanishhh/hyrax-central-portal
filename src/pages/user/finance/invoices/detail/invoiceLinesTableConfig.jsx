// pages/user/finance/invoices/detail/invoiceLinesTableConfig.jsx
// Read-only columns for an invoice's nested line items (sap_invoice_lines).
//
// Future enhancement (not this pass): enrich with base_entry/base_type to
// show which delivery/order each line traces back to.

export const invoiceLinesTableConfig = () => [
  {
    key: "item_code",
    label: "Item Code",
