        ...
        <>
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            <p className="textXS textLight">
              Who's here today, what needs HR action, and how attendance is
          ...
          {/* BY DEPARTMENT & NEEDS ATTENTION */}
          <div style={{ margin: "1rem 0" }}>
            <div
              style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}
            >
              <ChartPieSliceIcon size={24} />
              <h2 className="textL textBold">By Department</h2>
            </div>
            <p className="textXS textLight">
              Attendance rate by department, this period.
            </p>
          </div>
          ...
          <div style={{ margin: "1rem 0" }}>
            ...
            <p className="textXS textLight">
              Employees with the most absent days this period -- who HR
