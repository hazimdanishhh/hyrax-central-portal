export const stageTabsConfig = (currentStage, isCancelled, isOnHold) => [
  ...
  {
    label: "DISCOVERY",
    to: "?stage=DISCOVERY&cancelled=false&onHold=false",
    themeType: "blue",
    isActive: currentStage === "DISCOVERY" && !isCancelled && !isOnHold,
  },
  {
    label: "SAMPLE TEST",
    to: "?stage=SAMPLE_TEST&cancelled=false&onHold=false",
    themeType: "blue",
    isActive: currentStage === "SAMPLE_TEST" && !isCancelled && !isOnHold,
  },
  {
    label: "PROPOSAL",
    to: "?stage=PROPOSAL&cancelled=false&onHold=false",
    themeType: "blue",
    isActive: currentStage === "PROPOSAL" && !isCancelled && !isOnHold,
  },
  {
    label: "NEGOTIATION",
    to: "?stage=NEGOTIATION&cancelled=false&onHold=false",
    themeType: "blue",
