...
begin
    ...
    loop
        begin
            perform public.emit_notification_event(
                ...
                jsonb_build_object(
                    ...
                    'message', format(
                        'You are still clocked in for %s remote work session%s. %s be automatically clocked out around 11:59 PM MYT unless you clock out first. If you are still working after that, clock in again.',
                        v_row.open_count,
        ...
        exception when others then
            raise warning 'attendance.autoclockout_approaching (midnight) failed for employee %: %',
